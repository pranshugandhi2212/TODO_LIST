...
const regex = /toast\("Comment added locally. Server sync is not available right now."\);\s*setCommentSubmitting\(false\);\s*};\s*\);\s*}\s*return \(/;
                ...
                <div className="premium-task-card__collapsible-inner">
                  ...
                  <footer className="premium-task-card__footer">
                    ...
                    <div className="premium-task-actions">
                      <button className="premium-action-btn" onClick={(e) => { e.stopPropagation(); openCommentComposer(todo); }}>
                        <i className="bi bi-chat-left-text" /> <span>Comment</span>
                      </button>
                      <button className="premium-action-btn" onClick={(e) => { e.stopPropagation(); handleTaskEdit(todo); }}>
                        <i className="bi bi-pencil" /> <span>Edit Details</span>
                      </button>
                      <button className="premium-action-btn" title="Attach Files" onClick={(e) => e.stopPropagation()}>
